        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="widget">
                        <ul class="categories highlight col-bg-white">
                        ...
                        <div class="tabs">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="one">
                                    <ul class="popular">
                                        <li>
                                            <img src="/assets/themes/option1/images/prv/team-img-2.jpg" alt="" class="img-thumbnail pull-left">
                                            <p>
                                        ...
                                        <li>
                                            <img src="/assets/themes/option1/images/prv/team-img-3.jpg" alt="" class="img-thumbnail pull-left">
                                            <p>
                                                <a href="#">Dorlorem ipsum et mea dolor sit amet, usu timeam persius ea</a>
                                                <i>20th, June 2013</i>
                                            </p>
                                        ...
                                        <li>
                                            <img src="/assets/themes/option1/images/prv/team-img-1.jpg" alt="" class="img-thumbnail pull-left">
                                            <p>
                                                <a href="#">Dorlorem ipsum et mea dolor sit amet, usu timeam persius ea</a>
                                                <i>20th, June 2013</i>
                                            </p>
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 col-bg-white padding-15">
                            <div class="w-box blog-post">
                                <div class="figure">
                                    <img alt="" src="/assets/themes/option1/images/prv/wkp-img-1.jpg">
                                    <h2>option1 Bootstrap Template is a complete website for business, freelancers and creatives.</h2>
                                    <ul class="meta-list">
                                        <li>
                        ...
                        <div class="col-md-12 col-bg-white padding-15">
                            <div class="w-box blog-post">
                                ...
                                <div class="comments-wr">
                                    ...
                                    <div class="comment">
                                        <img src="/assets/themes/option1/images/prv/team-img-3.jpg" alt="">
                                    ...
                                    <div class="comment">
                                        <img src="/assets/themes/option1/images/prv/team-img-2.jpg" alt="">
                                        <p>
                                        It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.
                                        <br><br>
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut non libero magna. Sed et quam lacus.
                                        ...
                                        <div class="comment">
                                            <img src="/assets/themes/option1/images/prv/team-img-1.jpg" alt="">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut non libero magna. Sed et quam lacus. Fusce condimentum eleifend enim a feugiat.</p>
                                        </div>
